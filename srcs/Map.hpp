...
private:
	typedef RBTree<value_type, value_compare, false> Tree_type;
...
public:
	...
	explicit Map(const key_compare& comp = key_compare()) : _tree(value_compare(comp)), _comp(comp)
	{}

	template <typename InputIterator>
	Map(InputIterator first, InputIterator last, const key_compare& comp = key_compare()) :
		_tree(first, last, value_compare(comp)), _comp(comp)
	{}
